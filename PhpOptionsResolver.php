...
namespace Iriven;
use Iriven\Exceptions\AccessException;
use Iriven\Exceptions\InvalidOptionsException;
use Iriven\Exceptions\MissingOptionsException;
use Iriven\Exceptions\NoSuchOptionException;
use Iriven\Exceptions\OptionDefinitionException;
use Iriven\Exceptions\UndefinedOptionsException;
use Iriven\Interfaces\OptionsResolverInterface;

final class PhpOptionsResolver implements OptionsResolverInterface
{
    /**
     ...
     *
     * @return OptionsResolverInterface This instance
     *
    ...
    public function setDefault($option, $value)
    {
        ...
        if ($value instanceof \Closure) {
            ...
            if (isset($params[0]) && null !== ($class = $params[0]->getClass()) && OptionsResolverInterface::class === $class->name) {
